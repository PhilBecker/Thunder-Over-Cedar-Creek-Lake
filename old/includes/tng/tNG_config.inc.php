...
// Start Variable definitions
  ...
  $tNG_login_config["connection"] = "CCVF";
  $tNG_login_config["table"] = "tbl_login";
  ...
  $tNG_login_config["redirect_failed"] = "admin/LoginFail.php";
  $tNG_login_config["redirect_success"] = "admin/index.php";
  $tNG_login_config["login_page"] = "admin/login.php";
