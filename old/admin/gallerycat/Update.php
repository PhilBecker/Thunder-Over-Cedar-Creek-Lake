...
$upd_tbl_gallerycategories = new tNG_update($conn_AirShow);
$tNGs->addTransaction($upd_tbl_gallerycategories);
// Register triggers
$upd_tbl_gallerycategories->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Update1");
$upd_tbl_gallerycategories->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$upd_tbl_gallerycategories->registerTrigger("END", "Trigger_Default_Redirect", 99, "Results.php");
$upd_tbl_gallerycategories->registerTrigger("AFTER", "Trigger_ImageUpload", 97);
// Add columns
$upd_tbl_gallerycategories->setTable("tbl_gallerycategories");
$upd_tbl_gallerycategories->addColumn("CategoryName", "STRING_TYPE", "POST", "CategoryName");
$upd_tbl_gallerycategories->addColumn("Photo", "FILE_TYPE", "FILES", "Photo");
$upd_tbl_gallerycategories->addColumn("PhotoAlt", "STRING_TYPE", "POST", "PhotoAlt");
$upd_tbl_gallerycategories->setPrimaryKey("ID", "NUMERIC_TYPE", "GET", "ID");
...
$objDynamicThumb1->setFolder("../../assets/gallery/{rstbl_gallerycategories.ID}/");
$objDynamicThumb1->setRenameRule("{rstbl_gallerycategories.Photo}");
...
?>
    <form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" enctype="multipart/form-data">
      <table cellpadding="2" cellspacing="0" >
        <tr>
          <th width="102" valign="top" class="tablecell">&nbsp;</th>
          <td width="523" class="tablecell">&nbsp;</td>
        </tr>
        <tr>
          <th valign="top" class="tablecell">Category:</th>
          <td class="tablecell"><input type="text" name="CategoryName" id="CategoryName" value="<?php echo KT_escapeAttribute($row_rstbl_gallerycategories['CategoryName']); ?>" size="32" />
        ...
        <tr>
          ...
          <td class="tablecell"><input type="file" name="Photo" id="Photo" size="32" />
              <?php echo $tNGs->displayFieldError("tbl_gallerycategories", "Photo"); ?> <br />
			<img border="0" name="photo" src="<?php echo $objDynamicThumb1->Execute(); ?>" /></td>
        </tr>
        <tr>
        ...
        <tr>
          <td valign="top" class="tablecell">&nbsp;</td>
          <td class="tablecell"><input name="KT_Update1" type="submit" class="form" id="KT_Update1" value="Update" /></td>
        </tr>
      </table>
    </form>
    <p>&nbsp;</p>
