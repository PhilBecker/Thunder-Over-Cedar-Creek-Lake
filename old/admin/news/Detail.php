...
<table width="820" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="admintable">
  ...
  <tr>
	...
	<h1>News Detail</h1>
    <a href="Results.php">Results</a> | <a href="Insert.php">Insert News</a> | <a href="Update.php?NewsID=<?php echo $row_rsNews['NewsID']; ?>">Update</a> | <a href="Delete.php?NewsID=<?php echo $row_rsNews['NewsID']; ?>">Delete</a>
