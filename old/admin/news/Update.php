...
$upd_tbl_news = new tNG_update($conn_AirShow);
$tNGs->addTransaction($upd_tbl_news);
// Register triggers
$upd_tbl_news->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Update1");
$upd_tbl_news->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$upd_tbl_news->registerTrigger("END", "Trigger_Default_Redirect", 99, "Detail.php?NewsID={NewsID}");
$upd_tbl_news->registerTrigger("AFTER", "Trigger_ImageUpload", 97);
// Add columns
$upd_tbl_news->setTable("tbl_news");
$upd_tbl_news->addColumn("Date", "DATE_TYPE", "POST", "Date");
$upd_tbl_news->addColumn("Author", "STRING_TYPE", "POST", "Author");
$upd_tbl_news->addColumn("Title", "STRING_TYPE", "POST", "Title");
$upd_tbl_news->addColumn("Short", "STRING_TYPE", "POST", "Short");
$upd_tbl_news->addColumn("Copy", "STRING_TYPE", "POST", "Copy");
$upd_tbl_news->addColumn("Photo", "FILE_TYPE", "FILES", "Photo");
$upd_tbl_news->addColumn("PhotoAlt", "STRING_TYPE", "POST", "PhotoAlt");
$upd_tbl_news->setPrimaryKey("NewsID", "NUMERIC_TYPE", "GET", "NewsID");
...
$objDynamicThumb1->setRenameRule("{rstbl_news.Photo}");
    ...
    <form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" enctype="multipart/form-data">
      <table cellpadding="2" cellspacing="0" class="KT_tngtable">
        ...
        <tr>
          ...
          <td width="523" valign="top" class="tablecell"><input type="text" name="Date" id="Date" value="<?php echo KT_formatDate($row_rstbl_news['Date']); ?>" size="32" />
        ...
        <tr>
          ...
          <td valign="top" class="tablecell"><input type="text" name="Author" id="Author" value="<?php echo KT_escapeAttribute($row_rstbl_news['Author']); ?>" size="32" />
        ...
        <tr>
          ...
          <td valign="top" class="tablecell"><input type="text" name="Title" id="Title" value="<?php echo KT_escapeAttribute($row_rstbl_news['Title']); ?>" size="32" />
        ...
        <tr>
          ...
          <td valign="top" class="tablecell"><?php
// WebAssist iRite: Rich Text Editor for Dreamweaver
$WARichTextEditor_1 = CreateRichTextEditor ("Short", "../../WA_iRite/", "100%", "200px", "Basic", "../custom/Update_Short1.js", "".$row_rstbl_news['Short']  ."");
?>
        ...
        <tr>
          ...
          <td valign="top" class="tablecell"><?php
// WebAssist iRite: Rich Text Editor for Dreamweaver
$WARichTextEditor_2 = CreateRichTextEditor ("Copy", "../../WA_iRite/", "100%", "200px", "Basic", "../custom/Update_Copy2.js", "".$row_rstbl_news['Copy']  ."");
?>
        ...
        <tr>
          ...
          <td valign="top" class="tablecell"><input type="file" name="Photo" id="Photo" size="32" />
              <?php echo $tNGs->displayFieldError("tbl_news", "Photo"); ?><br />
		  <img border="0" name="photo" src="<?php echo $objDynamicThumb1->Execute(); ?>" alt="" /></td>
        </tr>
        <tr>
          <th valign="top" class="tablecell">Photo Alt:</th>
          <td valign="top" class="tablecell"><input type="text" name="PhotoAlt" id="PhotoAlt" value="<?php echo KT_escapeAttribute($row_rstbl_news['PhotoAlt']); ?>" size="32" />
        ...
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top" class="tablecell"><input name="KT_Update1" type="submit" class="form" id="KT_Update1" value="Update" /></td>
        </tr>
      </table>
    </form>
    <p>&nbsp;</p>
