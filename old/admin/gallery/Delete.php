...
<table width="820" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="admintable">
  ...
  <tr>
    ...
    <a href="DeletePhoto.php?PhotoID=<?php echo $row_rsPhoto['PhotoID']; ?>">Delete</a> | <a href="Results.php">Cancel</a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td colspan="2" align="center" valign="middle"><img border="0" src="<?php echo $objDynamicThumb1->Execute(); ?>" alt="<?php echo $row_rsPhoto['PhotoAlt']; ?>" name="photo" id="photo" /></td>
        </tr>
      <tr>
        <th valign="top">&nbsp;</th>
      ...
      <tr>
        ...
        <td width="83%" align="left" valign="top" class="tablecell"><?php echo KT_formatDate($row_rsPhoto['Date']); ?></td>
        </tr>
      <tr>
